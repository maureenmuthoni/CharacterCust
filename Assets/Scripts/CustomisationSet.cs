...
public class CustomisationSet : MonoBehaviour
{
    ...
    public int hairIndex, eyesIndex, mouthIndex;
    [Header("Renderer")]
    ...
    void SetTexture(string type, int dir)
    {
        ...
        void OnGUI()
            ...
            //GUI button on the left of the screen with the contence > 
            if(GUI.Button(new Rect(1.75f * scrW, scrH + i * (0.5f * scrH), scrW, 0.5f * scrH), ">"))
            ...
            if(GUI.Button(new UnityEngine.Rect(1.25f*scrW, scrH + i * (0.5f * scrH),scrW, 0.5f*scrH), "Reset"))
            {
                ...
                SetTexture("Hair", skinIndex = 0);
                SetTexture("Mouth", skinIndex = 0);
                SetTexture("Eyes", skinIndex = 0);
            }
            //move down the screen with the int using ++ each grouping of GUI elements are moved using this
            i++;
            #endregion
